...
const ForgotPasswordPage = () => {
  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(145deg,#f8fafc_0%,#ecfeff_55%,#f0fdfa_100%)] px-4 py-10">
      <section className="mx-auto w-full max-w-lg rounded-2xl border border-teal-100 bg-white p-7 shadow-[0_20px_60px_-35px_rgba(13,148,136,0.45)] md:p-8">
